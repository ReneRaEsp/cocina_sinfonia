...
use App\Repository\SunmiCloudPrinterRepository;
...
/**
 * @ORM\Entity(repositoryClass=SunmiCloudPrinterRepository::class)
 */
class SunmiCloudPrinter
{
    ...
    private const APP_ID = "a2bbe04c2abf437d92d7d3852600f260";
    private const APP_KEY = "dc7e3d481af342148bb31b4e595bdbf7";
