 ...
 */
final class Version20240318090148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tickets (id INT AUTO_INCREMENT NOT NULL, mesaid_id INT NOT NULL, numeroticket INT NOT NULL, INDEX IDX_54469DF47460A381 (mesaid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
