 ...
 */
final class Version20230206095512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock ADD provider_id INT DEFAULT NULL, ADD type_food_id INT DEFAULT NULL, DROP proveedores_id, DROP tipo_comida_id');
