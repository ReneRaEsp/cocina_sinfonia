<template>
  ...
  export default {
    setup() {
      ...
      //Main
      const statsComidaValue = document
        .querySelector("[data-statscomida]")
        .getAttribute("data-statscomida");
      items.value = JSON.parse(statsComidaValue);
